...
-files mapper1-withMTAdistance.py, reduce1-withMTAdistance.py \
-mapper mapper1-withMTAdistance.py  \
-reducer reduce1-withMTAdistance.py  \
-input BusSpeed/input  \
-output BusSpeed/output-MR
