...
in1 = LOAD 'BusSpeed/output-3months' AS (id:chararray,time:float, distance:float );
...
-- sort the output
 ave1_ordered = ORDER ave BY group ASC;

-- store the data
STORE ave1_ordered INTO 'BusSpeed/output-pig-all-mph-3months/' USING PigStorage ('\t');
